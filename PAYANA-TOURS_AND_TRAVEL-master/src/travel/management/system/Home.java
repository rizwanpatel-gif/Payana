...
public class Home extends JFrame implements Runnable, ActionListener{
    ...
    Home() {
        super("PAYANA: Tours and Travels");
        ...
        i4 = new ImageIcon(ClassLoader.getSystemResource("Travel/Management/System/icons/TT.jpg"));
	...
	button.add(l4);
        ...
        JLabel l5 = new JLabel(" PAYANA");
        l5.setForeground(Color.RED);
        l5.setFont(new Font("Algerian", Font.BOLD, 43));
	...
	panel1.add(this.jlabel[i]);
        ...
        l6.setFont(new Font("Comic Sans MS", Font.BOLD, 60));
        l6.setHorizontalAlignment(SwingConstants.CENTER);
        l6.setBounds(0, 300, 1540, 110);
	jlabel[i].add(l6);
        }
        t1 = new Thread(this);

...
public class Front extends JFrame implements ActionListener{
        ...
        Front() {
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("Travel/Management/System/icons/frontpage1.jpg"));
                ...
                JLabel l2=new JLabel("PAYANA: TOURS AND TRAVELS");
                l2.setBounds(300, 10, 1345, 100);
